...
import './BestCameraPhone.css';
import axios from 'axios';
import { Link } from 'react-router-dom';

class BestCameraPhone extends React.Component {
    ...
    return (
      ...
      <div className="container-fluid p-2" style={{ maxWidth: '1680px' }}>
        <div className="row p-2 m-0">
            <div className="col-md-12 col-lg-12 col-xl-12 globle-shadow"> 
                <div className="col-lg-12"> 
                    <h3 className="px-3 py-2 m-0"> Best Of Electronics  <span> <Button className="float-right globel-btn-color"> View All </Button> </span> </h3> 
                </div>
                <hr className="m-2" />
...
export default BestCameraPhone;
